...
SOURCES = {
    ...
    "villa_vijver":   ("2025/05/6persoonsL-DeWielscheDreef-79-scaled.jpg", 0.42,
                       "Villa aan de vijver met rietoevers"),
    "fietsers_najaar": ("2025/11/verkoopdag.jpg", 0.40,
                       "Fietsen over de laan in het najaar"),
